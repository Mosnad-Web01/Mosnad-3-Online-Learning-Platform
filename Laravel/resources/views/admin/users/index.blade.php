            ...
            <td class="px-4 py-3 text-right">
                <div class="relative">
                    ...
                    <div id="user-{{ $user->id }}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <div class="py-1">
                            <a href="{{ route('users.destroy', $user->id) }}" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</a>
                        </div>
                    </div>
                </div>
            </td>
