                    ...
                    <table class="min-w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Is Suspended</th>
    ...
    @foreach ($users as $user)
        <tr class="border-b dark:border-gray-700">
            ...
            <td class="px-4 py-3 text-right">
                <!-- الزر لتحرير المستخدم -->
                <div class="relative inline-flex items-center">
                    <a href="{{route('users.edit', ['user' => $user->id]) }}" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
