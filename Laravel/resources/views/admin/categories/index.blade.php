                ...
                @forelse ($categories as $category)
                    <div class="bg-white rounded-lg shadow dark:bg-gray-800">
                        <div class="p-4">
                            ...
                            @if ($category->image)
                                <img src="{{ Storage::url($category->image) }}" alt="Category Image" class="w-full h-48 object-cover rounded-lg mt-4">
                            @endif
                            <p class="text-gray-600 dark:text-gray-300 mt-4">{{ $category->description }}</p>
                            <div class="flex mt-4">
                                <!-- Edit Button -->
